...
def visualize_vertipaq(dataframes):
    ...
    data = [
        ...
        {'ViewName': 'Table', 'ColumnName': 'Partitions', 'Tooltip': 'The number of partitions in the table'},
        {'ViewName': 'Table', 'ColumnName': 'Columns', 'Tooltip': 'The number of columns in the table'},
        ...
        {'ViewName': 'Relationship', 'ColumnName': 'Multiplicity', 'Tooltip': 'The cardinality on each side of the relationship'},
