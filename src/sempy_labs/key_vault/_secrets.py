...
def list_secrets(key_vault_uri: str) -> pd.DataFrame:
    ...
    This is a wrapper function for the following API: `List Secrets - List Secrets <https://learn.microsoft.com/rest/api/keyvault/secrets/get-secrets/get-secrets>`_.
    ...
    response = _base_api(request=f"{key_vault_uri}/secrets", client="keyvault")
