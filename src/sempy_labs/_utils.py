item_types = {
    ...
    "KQLDatabase": ["KQL Database", "kqlDatabases"],  # "DatabaseProperties.json", "DatabaseSchema.kql"
    ...
    "MirroredDatabase": ["Mirrored Database", "mirroredDatabases", "mirroredDatabase.json"],
    ...
    "SparkJobDefinition": ["Spark Job Definition", "sparkJobDefinitions", "SparkJobDefinitionV1.json"],
